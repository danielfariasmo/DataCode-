...
public class MenuPrincipalGameMaster extends JFrame {
	...
	public void configuracionInicial() {
		...
		groupLayout.setHorizontalGroup(groupLayout.createParallelGroup(Alignment.LEADING).addComponent(scrollPrincipal,
				GroupLayout.PREFERRED_SIZE, 1286, GroupLayout.PREFERRED_SIZE));
		groupLayout.setVerticalGroup(groupLayout.createParallelGroup(Alignment.LEADING).addComponent(scrollPrincipal,
