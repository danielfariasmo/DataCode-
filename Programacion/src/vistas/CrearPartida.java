...
public class CrearPartida extends JPanel {
	...
	public void inicializarComponentes() {
		...
		labelDuracionSesion.setBounds(187, 350, 400, 30);
		...
		labelEstado.setBounds(184, 454, 434, 30);
		add(labelEstado);
		...
		textoIdentificador.setBounds(629, 30, 400, 41);
		...
		textoNumeroSesion.setBounds(629, 397, 400, 41);
