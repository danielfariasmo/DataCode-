...
public class InfoPartidaJugador extends JPanel {
	...
	public void inicializarComponentes() {
		...
		labelTitulo.setBounds(410, 48, 305, 60);
		add(labelTitulo);
		...
		scrollPane.setBounds(95, 257, 952, 153);
		add(scrollPane);
		...
		botonUnirmePartida.setBounds(452, 436, 208, 43);
